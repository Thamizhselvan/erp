...
<form role="form">
	 <div id="page-wrapper">
            <div id="page-inner">
				<div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Allowance</h1>
                               ...
                               <div class="col-md-6"> 
                                ...
                                <div class="col-md-6">
									 <div class="form-group">
                                            ...
                                            <div ><select id="allowanceCode" class="form-control" onchange="getAllowance()">
                                ...
                                <div class="col-md-6">
									 <div class="form-group">
                                            ...
                                            <div  ><input type="text" class="form-control" id="allowanceType"></div>
                                     <!-- <p class="help-block">Help text here.</p> -->
                                     </div>
                                </div>
								<div class="col-md-6">
                                ...
                                <div class="col-md-3">
									 <div class="form-group">                                            
                                            <div>
												...
												<input type="button" class="btn btn-info form-control" value="save" id="save" onclick="allowance(this)">
											</div>
                                     <!-- <p class="help-block">Help text here.</p> -->
                                     </div>
                                </div>
                                <div class="col-md-3">
									 <div class="form-group">                                            
                                            <div>											
												<input type="button" class="btn btn-info form-control" value="update" id="update" onclick="allowance(this)">
											</div>
                                     <!-- <p class="help-block">Help text here.</p> -->
                                     </div>
                                </div>
