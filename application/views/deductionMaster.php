                    ...
                    <div class="panel-body">
                               ...
                               <div class="col-md-6"> 
                                ...
                                <div class="col-md-3">
									 <div class="form-group">                                            
                                            <div>
												...
												<input type="button" class="btn btn-info form-control" value="save" id="save" onclick="deduction(this)">
											</div>
                                     <!-- <p class="help-block">Help text here.</p> -->
                                     </div>
                                </div>
                                <div class="col-md-3">
									 <div class="form-group">                                            
                                            <div>											
												<input type="button" class="btn btn-info form-control" value="update" id="update" onclick="deduction(this)">
											</div>
                                     <!-- <p class="help-block">Help text here.</p> -->
                                     </div>
                                </div>
